...
const columns = useMemo(() => [
  ...
  { field: "weight", headerName: "Weight", valueFormatter: (row: ValueFormatterParams<User>) => {
    const { weight } = row.data ?? {};
    return columnFormatter.formattedWeight(weight);
  } },
  { field: "height", headerName: "Height", valueFormatter: (row: ValueFormatterParams<User>) => {
